...
public class RecorderControlUtils {
    //录音
    ...
    public RecorderControlUtils() {

    }

    public RecorderControlUtils(String name) {
        if (mRecorder == null) {
    ...
    public void playingFinish() {
        LogUtils.i("spoort_list", "RecorderControl 播放结束释放资源");
        if (playState) {
            playState = false;
        }
        mPlayer.release();
    ...
    public boolean stopPlaying() {
        ...
        if (mPlayer != null) {
            ...
            LogUtils.i("spoort_list", "RecorderControl mPlayer.stop()");
            mPlayer.stop();
            mPlayer.release();
            mPlayer = null;
            playState = false;
            ...
            LogUtils.i("spoort_list", "RecorderControl mPlayer.stop() is null");
            return false;
        }
    }
    //当文件播放结束后调用此方法
    ...
    ////				playState = false;
    ////			}
    //			LogUtils.i("spoort_list", "RecorderControl 播放结束");
    //			mPlayer.release();
    //			mPlayer = null;
    //		}
    //	};
