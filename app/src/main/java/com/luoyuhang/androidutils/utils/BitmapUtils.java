...
public class BitmapUtils {
    ...
    public static Bitmap getBitmapFromView2(View view) {
        ...
        if (cacheBitmap == null) {
            if (DEBUG) {
                LogUtils.e(TAG, "failed getViewBitmap(" + view + "), " +
    ...
    /**
     * 返回表示指定位图缩略图的位图. The
     * 缩略图的大小由android.R.dimen.launcher_application_icon_size.定义
     * <p/>
     * 此方法不是安全的线程，应该只能在UI线程上调用
     *
    ...
    /**
     * 更安全的decodeStream方法
     * 而不是{@link BitmapFactory}
     * 这将很容易得到OutOfMemory异常
     * 加载大图像文件时
