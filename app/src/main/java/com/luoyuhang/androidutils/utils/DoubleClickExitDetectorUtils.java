...
public class DoubleClickExitDetectorUtils {
     ...
     */
    public DoubleClickExitDetectorUtils(Context context, String hintMessage, int effectiveIntervalTime) {
     ...
     */
    public DoubleClickExitDetectorUtils(Context context, String hintContent) {
